...
router.patch('/deletereview/:reviewId', auth.verifyUserToken, movieController.deleteReview);
router.get('/listuserreviews', auth.verifyUserToken, movieController.listUserReviews);
...
router.get('/accesscommunitymsg/:chatId', auth.verifyUserToken, communityController.accessCommunityMsg);
